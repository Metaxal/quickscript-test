...
(fire-up-drracket-and-run-tests
 ...
 (λ ()
   ...
   ;; Create new script.
   ;; Doesn't work as of now because I can't get hold of the frame
   ;; generated by get-text-from-user from Quickscript.
   #;
   (begin
     ; random name.
     ...
     (sleep 1)
     ;; For some reason I can't get hold of the frame generated by
     ;; get-text-from-user
     (define script-name-msgbox
       (test:get-active-top-level-window)
       #;(wait-for-new-frame drr))
     (displayln script-name-msgbox)
     #;(wait-for-drracket-frame)
     (send script-name-msgbox focus)
...
EOS
     ...
     (debug-read-line)
     (check-pred (file-exists? filestring))
